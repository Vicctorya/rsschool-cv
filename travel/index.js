console.log('оценка за задание 95 баллов\n\n',
...
'плавная прокрутка по якорям - нет \n',
'иконки соцсетей в футере при нажатии на них ведут на гитхаб автора проекта и на страницу курса (допускается добавление своих вариантов иконок github или RSSchool) https://rs.school/js-stage0/ - есть ссылки на github или RSSchool +5 \n',
